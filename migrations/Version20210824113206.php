 ...
 */
final class Version20210824113206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, restaurante_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, comentario VARCHAR(255) DEFAULT NULL, puntos DOUBLE PRECISION NOT NULL, created_at DATE NOT NULL, INDEX IDX_4B91E70238B81E49 (restaurante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE direccion (id INT AUTO_INCREMENT NOT NULL, provincia_id INT NOT NULL, municipio_id INT NOT NULL, cliente_id INT NOT NULL, calle VARCHAR(255) NOT NULL, numero VARCHAR(50) DEFAULT NULL, puerta_piso_escalera VARCHAR(255) DEFAULT NULL, cod_posttal INT NOT NULL, INDEX IDX_F384BE954E7121AF (provincia_id), INDEX IDX_F384BE9558BC1BE0 (municipio_id), INDEX IDX_F384BE95DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE horario_restaurante (id INT AUTO_INCREMENT NOT NULL, dia INT NOT NULL, apertura TIME NOT NULL, cierre TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pedido (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, direccion_id INT NOT NULL, estado_id INT NOT NULL, restaurante_id INT NOT NULL, total DOUBLE PRECISION NOT NULL, fecha_entrega DATETIME NOT NULL, relation VARCHAR(255) NOT NULL, INDEX IDX_C4EC16CEDE734E51 (cliente_id), INDEX IDX_C4EC16CED0A7BD7 (direccion_id), INDEX IDX_C4EC16CE9F5A440B (estado_id), INDEX IDX_C4EC16CE38B81E49 (restaurante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE restaurante (id INT AUTO_INCREMENT NOT NULL, horario_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, logo_url VARCHAR(255) NOT NULL, imagen_url VARCHAR(255) DEFAULT NULL, descripcion VARCHAR(255) DEFAULT NULL, destacado TINYINT(1) NOT NULL, valoracion_media DOUBLE PRECISION NOT NULL, INDEX IDX_5957C2754959F1BA (horario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE restaurante ADD CONSTRAINT FK_5957C2754959F1BA FOREIGN KEY (horario_id) REFERENCES horario_restaurante (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurante DROP FOREIGN KEY FK_5957C2754959F1BA');
